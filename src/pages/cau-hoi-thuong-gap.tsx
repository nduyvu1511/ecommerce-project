        ...
        <div className="static__page">
          ...
          <div className="">
            <h3>
              ...
              ưu đãi hấp dẫn chỉ dành riêng cho khách hàng đăng ký tài khoản tại Womart Shop bao
              gồm:
            </h3>
          ...
          <div className="">
            ...
            <h4>Mua hàng tại Womart Shop đơn giản và tiện lợi chỉ với 2 bước:</h4>
            ...
            <h3>Bước 2: Điền Thông Tin & Thanh Toán</h3>
            <ul>
              <li>
          ...
          <div className="">
            ...
            <h4>- Đơn hàng đã bao gồm thuế giá trị gia tăng VAT không?</h4>
            <p>
              Tất cả sản phẩm được bán tại website womart.vn, giá đã bao gồm thuế giá trị gia tăng
              VAT
            </p>
            <p>
          ...
          <div className="">
            ...
            <p>
              Womart Shop giao hàng các ngày trong tuần (kể cả thứ 7 và Chủ nhật). Thời gian giao
              hàng từ 2 đến 3 ngày tính từ khi đơn hàng được đặt thành công và có sự xác nhận của
              nhân viên chăm sóc khách hàng của Womart Shop
            </p>
          </div>
          ...
          <div className="">
            ...
            <ul>
              <li>
                ...
                chuyển đối với các quận: quận 1, quận 3, quận 4, quận 10, quận Bình Thạnh và quận
                Phú Nhuận.
              </li>
              <li>
                Đối với đơn hàng có giá trị từ 999.999 VNĐ đến 1.999.999 VNĐ: Womart Shop miễn phí
                vận chuyển đối với các quận: quận 1, quận 3, quận 4, quận 10, quận 5, quận 11, quận
                Bình Thạnh, quận Phú Nhuận, Tân Bình, Gò Vấp.
              </li>
              <li>
                Đối với đơn hàng có giá trị trên 2.000.000 VNĐ: Womart Shop miễn phí vận chuyển hầu
                hết các quận ngoại trừ Nhà Bè, Hóc Môn và Bình Chánh. Đối với những đơn hàng có giá
                trị dưới 300.000 VNĐ: Womart Shop mức phí vận chuyển dao động từ 20.000 VNĐ đến
                40.000 VNĐ tùy theo khu vực quý khách đặt đơn hàng và giá trị đơn hàng. Womart Shop
                giao hàng cho các quận thuộc Thành phố Hồ Chí Minh, ngoại trừ huyện Cần Giờ, và
                huyện Củ Chi.
              </li>
            </ul>
          </div>
          ...
          <div className="">
            ...
            <ul>
              <li>
                Thời gian đổi trả: Trong vòng 10 ngày cho sản phẩm điện máy, và trong vòng 14 ngày
                cho các sản phẩm còn lại
              </li>
              <li>
                Thời gian thông báo đổi trả: trong vòng 48h kể từ khi nhận sản phẩm đối với trường
              ...
              <li>
                ...
                Khách hàng - A10.08, Block A, Tầng 10, Tòa nhà Officetel Sky Center, Số 5B Phổ
                Quang, Phường 2, Quận Tân Bình,Tp. Hồ Chí Minh, Việt Nam
              </li>
            </ul>
          </div>
...
CauHoiThuongGap.Layout = MainNoFooter
